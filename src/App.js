...
export default function App() {
  ...
  function hanldeAddFriend(friend){
  ...
  <div className="app">
    <div className="sidebar">
      ...
      {showAddFriend && <FormAddFriend onAddFriend={hanldeAddFriend}/>}
...
function Friend({friend, onSelection, selectedFriend}){
  ...
  return (
    <li className={isSelected?'selected':''}>
      ...
      {friend.balance > 0 && (
        <p className="red"> {friend.name} owes you {Math.abs(friend.balance)}</p>
      )}
      {friend.balance === 0 && (
...
function FormAddFriend({onAddFriend}) {
  ...
  return <form className="fo
  rm-add-friend" onSubmit={handleSubmit}>
